      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-24">
        <div className="space-y-4 text-left">
          <div className="flex items-center gap-4">
            <span className="editorial-heading text-4xl text-violet-400">Chapter III</span>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {cat.skills.map((skill, sIdx) => (
                    <span
                      key={sIdx}
                      className="px-4 py-2 text-xs font-bold rounded-xl bg-white/5 border border-white/5 text-slate-300 select-none shadow-sm hover:border-violet-500/20 hover:text-white transition-all duration-300"
                    >
                      {skill}
                    </span>
                  ))}
